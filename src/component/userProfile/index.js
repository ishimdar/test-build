          ...
          <div className="about row">
            ...
            <div className="col-md-8 about-detail">
              <div className="detal-jumbo">
                <h3>
                  Hello I'm Frontend / Ui Developer with ReactJs/AngularJs
                </h3>
                <p>
                ...
                <p>
                  HTML5 & CSS3: Expertise in semantic HTML and CSS for
                  structuring and styling web pages, along with knowledge of CSS
                  preprocessors like SASS/SCSS.
                </p>
              </div>
              <div className="links">
                <div className="row ">
                    ...
                    <div className="cbp_tmlabel empty">
                      ...
                      <span>
                        ...
                        <p>
                          ...
                          projects. In both projects, I have used ReactJS,
                          Redux, Bootstrap, MUI, HTML5, CSS3, Responsiveness.
                        </p>
                      </span>{" "}
                    </div>
                  </li>
